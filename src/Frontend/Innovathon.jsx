...
const PopupBox = styled(motion.div)`
  ...
  @media(max-width:480px){padding:15px;font-size:0.9rem;}
...
const Innovathon = ({ isOpen, onClose }) => (
  <AnimatePresence>
    {isOpen && (
      <Overlay initial={{opacity:0}} animate={{opacity:1}} exit={{opacity:0}} onClick={onClose}>
        <PopupBox initial={{y:50,opacity:0}} animate={{y:0,opacity:1}} exit={{y:50,opacity:0}} transition={{type:"spring",stiffness:300,damping:25}} onClick={e=>e.stopPropagation()}>
          <Title>Innovathon</Title>

          <Section>
            <h3>Rules:</h3>
            <ul>
              <li>Team of 3-5 participants</li>
              <li>Time: 4 hours</li>
              <li>Innovative project presentation required</li>
            </ul>
          </Section>
          ...
          <Section>
            ...
            <ul>
              <li>Innovation – 40%</li>
              <li>Feasibility – 30%</li>
              <li>Presentation & Q&A – 30%</li>
            </ul>
          </Section>
